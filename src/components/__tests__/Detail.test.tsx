...
describe("render detail component", () => {
	test("test component with axios mock and parameters of title and id", async () => {
		...
		render(
			<MemoryRouter initialEntries={["/detail/the-dark-knight/d6822b7b-48bb-4b78-ad5e-9ba04c517ec8"]}>
				<Routes>
					<Route path="/detail/:title/:id" element={<Detail />}></Route>
				</Routes>
			</MemoryRouter>
		);

		await waitFor(() => {
			const textElement = screen.getByText(/The Dark Knight/i);

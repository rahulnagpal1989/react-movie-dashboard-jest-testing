...
describe("render search component", () => {
	test("test component with axios mock and parameter of title", async () => {
		...
		render(
			<MemoryRouter initialEntries={["/search/the dark knight"]}>
				<Routes>
					<Route path="/search/:title" element={<Home />}></Route>
				</Routes>
			</MemoryRouter>
		);
